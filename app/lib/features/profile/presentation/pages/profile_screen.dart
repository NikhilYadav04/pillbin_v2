...
class ProfileScreen extends StatefulWidget {
  final bool isVendor;
  const ProfileScreen({Key? key, this.isVendor = false}) : super(key: key);
...
class _ProfileScreenState extends State<ProfileScreen>
  ...
  Future<void> _fetchUserDetails({bool isRefresh = false}) async {
    ...
    final result = await userProvider.getProfile(forceRefresh: isRefresh);
    if (result == 'success_cache' && mounted) {
      CustomSnackBar.show(
          context: context,
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          SizedBox(height: sh * 0.025),
          buildVendorCenterCard(sw, sh, false, context),
          if (!widget.isVendor) ...[
            isLoading
          ...
          buildProfileSettings(sw, sh, false, context, isVendor: widget.isVendor),
              ...
              children: [
                ...
                Expanded(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        buildVendorCenterCard(sw, sh, true, context),
