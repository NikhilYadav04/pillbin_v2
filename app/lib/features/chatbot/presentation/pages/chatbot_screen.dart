...
class _ChatBotScreenState extends State<ChatBotScreen>
  ...
  void initState() {
    ...
    setState(() {
      messages.add(
        ChatMessage(
          message:
              "Hello! I'm your PillBin assistant. How can I help you today?",
          isUser: false,
  ...
  void _sendMessage() async {
    ...
    ChatbotProvider _provider = context.read<ChatbotProvider>();
    String response = await _provider.sendQueryToChatbot(
    ...
    if (response == 'Cannot reach server, please try again') {
      return;
    } else {
      setState(() {
        messages.add(
