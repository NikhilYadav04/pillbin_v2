...
class _LandingPageState extends State<LandingPage>
          ...
          children: [
            ...
            Container(
              ...
              child: Material(
                ...
                child: InkWell(
                  borderRadius: BorderRadius.circular(isTablet ? 16 : 12),
                  onTap: () => _showRoleSelectionSheet(context, sw, sh),
                  child: Padding(
                    padding: EdgeInsets.symmetric(
  ...
  void _showRoleSelectionSheet(BuildContext context, double sw, double sh) {
          ...
          child: Column(
            ...
            children: [
              ...
              _buildRoleCard(
                ...
                title: 'I\'m a User',
                subtitle: 'Track medicines, find disposal centers & donate',
                role: 'user',
              ),
              ...
              _buildRoleCard(
                ...
                title: 'I\'m a Medical Center / Vendor',
                subtitle: 'Register your center, manage inventory & requests',
                role: 'vendor',
              ),
              SizedBox(height: sh * 0.03),
            ],
